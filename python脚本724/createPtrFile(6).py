...
#dnstmpdir = ''
#dnsptrdir = ''
#dnsptrfile1= raw_input("please input where is dnsptr file like(\033[1;32;40m/var/test/headinfo.txt\033[0m)")
#dnstmpdir1= raw_input("please input where is dnsconf file like(\033[1;32;40m/var/test/tmpdir\033[0m)")
#dnsptrdir1= raw_input("please input where is dnsconf file like(\033[1;32;40m/var/test/ptr\033[0m)")
