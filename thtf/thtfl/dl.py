...
class Proxy(object):
    def __init__(self,conn,addr):
        ...
        self.request = ""
        self.headers = {}
        self.destnation = socket.socket(socket.AF_INET,socket.SOCK_STREAM)  ###建立一个socket连接
        self.run()
    ...
    def conn_desnation(self):
        ...
        self.destnation.send((data+self.request).encode())
        print ("###")
        print (data)
        print ('#####')
        print (self.request)
